package fr.gouv.education.sirhen.demo.scenario;
...
import fr.gouv.education.sirhen.demo.page.PageAccueil;
import fr.gouv.education.sirhen.demo.page.PageResultatRecherche;
...
public class ScenarioRechercheLivre {
	...
	@Test
	public void testRechercherLivrer(@InitialPage final PageAccueil pageAccueil) {
...
//		}
		...
		pageAccueil.setRecherche("java");
		PageResultatRecherche pageResultatRecherche = pageAccueil.lancerRecherche();
		int nombreResultats = pageResultatRecherche.getNombreResultats();
		
		Assert.assertTrue(nombreResultats > 300);
