...
import fr.gouv.education.sirhen.gin.gestiondescontratsdesnontitulaires.mapi.selenium.page.PageAccueilPortailAgent;
...
public class ScenarioInformationsContact {
	...
	public void testInitiationContratAgentNonTitulaire(@InitialPage final PageAuthentification pageAuthentification) {
		...
		pageAuthentification.setIdentifiant("apendaries");
		pageAuthentification.setChampMotDePasse("logica");
		PageAccueilPortailAgent pageAccueilPortailAgent = pageAuthentification.connexion();
		pageAccueilPortailAgent.naviguePageSituationPersonnelle();
